...
import {Box, HStack, Icon, VStack, Text, Avatar} from 'native-base';
...
const ProfileList: FC = () => {
  const state = [
    {
      icon: <SIIcons name="pencil" />,
      id: '1',
      name: 'Edit Profile',
      screen: '',
    },
    {
      icon: <SIIcons name="user-follow" />,
      id: '2',
      name: 'Follow Us',
      screen: '',
    },
    {
      icon: <MCIcon name="comment-text-outline" />,
      id: '3',
      name: 'Talk To Us',
      screen: '',
    },
    {
      icon: <SIIcons name="settings" />,
      id: '4',
      name: 'Settings',
      screen: '',
    },
    {
      icon: <MCIcon name="chat-alert-outline" />,
      id: '5',
      name: 'Instructions',
      screen: '',
    },
    {
      icon: <Iconicons name="exit-outline" />,
      id: '6',
      name: 'Sign-Out',
      screen: '',
    },
    {
      icon: <Anticons name="delete" />,
      id: '7',
      name: 'Delete Account',
      screen: '',
    },
